...
def main():
    ...
    # JSON de métricas (alineado con Random Forest)
    metricas = {
    ...
    print(f"[OK] Métricas guardadas en: {RUTA_METRICAS}")

    with open(RUTA_REPORTE_CLASIFICACION, "w", encoding="utf-8") as f:
        f.write(rep)
    print(f"[OK] Reporte de clasificación guardado en: {RUTA_REPORTE_CLASIFICACION}")
