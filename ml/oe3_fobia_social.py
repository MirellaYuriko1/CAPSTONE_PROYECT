# ml/oe3_fobia_social.py
# ------------------------------------------------------------
# OE3 - Fobia social
# Principal: UPPERBOUND (usa SOLO los ítems de Dim3)
# Opcional : LOSO (excluye Dim3 y usa Dim1,2,4,5,6 + edad + género)
# Salidas: reports/oe3_fobia_social/{tables,figs,figs_ml,tables_ml}
# ------------------------------------------------------------
...
UI = {
    ...
    "roc_title": "Curvas ROC por nivel — Fobia social",
    "roc_x":     "Falsos positivos (FPR)",
    "roc_y":     "Verdaderos positivos (TPR)",

    "pr_title":  "Curvas Precisión–Recall por nivel — Fobia social",
    "pr_x":      "Recall",
    "pr_y":      "Precisión",

    "cal_title": 'Calibración de probabilidades — nivel "Muy alto" (Fobia social)',
    "cal_leg1":  "Observado",
    "cal_leg2":  "Perfectamente calibrado",
    "cal_x":     "Probabilidad predicha",
    "cal_y":     "Fracción observada",

    "cv_title":  "Estabilidad en validación cruzada (k=5) — F1_macro (Fobia social)",
    "cv_y":      "F1_macro",

    "thr_title": 'Ajuste de umbral — nivel "Muy alto" (Fobia social)',
    "thr_x":     "Umbral de decisión",
    "thr_y":     "Valor",

    "imp_items_title": "Aporte de cada ítem (Dim3) — Fobia social",
    "imp_items_x":     "Importancia (permutación)",
    "imp_items_y":     "Ítems de la subescala",

    "learn_title": "Curva de aprendizaje — Random Forest (F1_macro) — Fobia social",
...
def cargar_dataset():
    ...
    for _, row in df.iterrows():
        ...
        nombre_sub = DIM_NOMBRES[DIM_KEY]  # "FobiaSocial"
