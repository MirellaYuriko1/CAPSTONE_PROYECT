...
RUTA_CURVA_CSV             = DIR_OUT / "learning_curve_cart.csv"
...
def main():
    ...
    joblib.dump(cart, RUTA_MODELO)
    with open(RUTA_PARAMS, "w", encoding="utf-8") as f:
        json.dump({"params": CART_PARAMS, "features_used": FEATURES}, f, ensure_ascii=False, indent=2)
