...
RUTA_CURVA                 = DIR_OUT / "curva_entrenamiento_validacion_cb.png"
RUTA_CURVA_CSV             = DIR_OUT / "curva_entrenamiento_validacion_cb.csv"  # <-- CSV nuevo
...
def construir_modelo_catboost(X_train, y_train, cv, ruta_png, ruta_csv):
    ...
    plt.ylim(0, 1)  # escala 0–1 como referencia estándar
    ...
    # Devuelvo solo medias (tu JSON actual las espera así)
...
def main():
    ...
    # Curva de aprendizaje (TRAIN y VALID con CV-5) + CSV
    sizes_abs, tr_scores, va_scores = construir_modelo_catboost(
