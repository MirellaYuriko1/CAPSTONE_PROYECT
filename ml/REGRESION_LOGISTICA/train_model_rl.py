...
RUTA_CURVA                 = DIR_OUT / "curva_entrenamiento_validacion_rl.png"
RUTA_CURVA_CSV             = DIR_OUT / "learning_curve_rl.csv"
RUTA_METRICAS              = DIR_OUT / "metricas_rl.json"
RUTA_REPORTE_CLASIFICACION = DIR_OUT / "reporte_clasificacion_rl.txt"
...
def main():
    ...
    joblib.dump(pipe, RUTA_MODELO)  # guarda el pipeline completo
    with open(RUTA_PARAMS, "w", encoding="utf-8") as f:
        json.dump({"params": LR_PARAMS, "features_used": FEATURES}, f, ensure_ascii=False, indent=2)
