...
# Carpeta específica para resultados de LightGBM en el objetivo somático
...
# =========================
# Mantenemos la configuración exacta del objetivo general
# para que la comparación en tu tesis sea válida.
LGBM_PARAMS = dict(
...
def main():
    ...
    print(f"[INFO] Analizando Dimensión Somática con LightGBM (Items 3, 4, 5).")
    ...
    ax_cm.set_title("Matriz de Confusión: Dimensión Somática (LightGBM)", fontsize=12, weight='bold')
    ...
    plt.tight_layout()
    ruta_cm = DIR_OUT / "matriz_confusion_somatico_lgbm.png"
    ...
    df_resumen = pd.DataFrame([{
        "Modelo": "LightGBM (Dimensión Somática)",
