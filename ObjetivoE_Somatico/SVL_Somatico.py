...
# Síntomas que quieres analizar en este OE2-Fisiologico (PHQ-9)
...
def main():
   ...
   ruta_global = DIR_OUT / "metricas_dimension_fisiologica_svl.csv"
   df_global_modelo.to_csv(ruta_global, index=False, encoding="utf-8-sig")
   print(f"[OK] Métricas globales de la dimensión (SVM lineal) guardadas en:", ruta_global)
