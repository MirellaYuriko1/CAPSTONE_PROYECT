...
# Carpeta específica para resultados de SVL en el objetivo somático
DIR_OUT = Path("ObjetivoE_Somatico/resultados_SVL")
...
def main():
    ...
    print(f"[INFO] Analizando Dimensión Somática con SVM Lineal ({len(ITEMS)} ítems).")
    ...
    ax_cm.set_title("Matriz de Confusión: Dimensión Somática (SVL)", fontsize=12, weight='bold')
    ...
    plt.tight_layout()
    ruta_cm = DIR_OUT / "matriz_confusion_somatico_svl.png"
    ...
    df_resumen = pd.DataFrame([{
        "Modelo": "SVM Lineal (Dimensión Somática)",
