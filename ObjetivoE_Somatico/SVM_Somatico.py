...
# Carpeta específica para resultados de SVM (RBF) en el objetivo somático
DIR_OUT = Path("ObjetivoE_Somatico/resultados_SVM")
...
def main():
    ...
    print(f"[INFO] Analizando Dimensión Somática con SVM (RBF) ({len(ITEMS)} ítems).")
    ...
    ax_cm.set_title("Matriz de Confusión: Dimensión Somática (SVM-RBF)", fontsize=12, weight='bold')
    ...
    plt.tight_layout()
    ruta_cm = DIR_OUT / "matriz_confusion_somatico_svm.png"
    ...
    df_resumen = pd.DataFrame([{
        "Modelo": "SVM (RBF) (Dimensión Somática)",
