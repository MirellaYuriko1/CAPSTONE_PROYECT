...
# Carpeta para resultados de SVM en el objetivo somático
...
def main():
    ...
    ruta_global = DIR_OUT / "metricas_dimension_fisiologica_svmrbf.csv"
    df_global_modelo.to_csv(ruta_global, index=False, encoding="utf-8-sig")
    print(f"[OK] Métricas globales de la dimensión (SVM RBF) guardadas en:", ruta_global)
