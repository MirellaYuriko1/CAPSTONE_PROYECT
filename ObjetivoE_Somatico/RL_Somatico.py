...
# Carpeta para resultados de Regresión Logística en el objetivo somático
...
def main():
    ...
    ruta_global = DIR_OUT / "metricas_dimension_fisiologica_lr.csv"
    df_global_modelo.to_csv(ruta_global, index=False, encoding="utf-8-sig")
    print(f"[OK] Métricas globales de la dimensión (Logistic Regression) guardadas en:", ruta_global)
