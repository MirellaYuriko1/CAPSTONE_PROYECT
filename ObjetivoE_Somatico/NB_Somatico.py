# NB_O2/NB_O2.py  (o renómbralo a ObjetivoE_Somatico/NB_Somatico.py si prefieres)
...
# Carpeta para resultados de Naive Bayes en el objetivo somático
...
def main():
    ...
    # ======================================================
    #   MÉTRICAS GLOBALES DEL OE2 (DIMENSIÓN FISIOLÓGICA)
    # ======================================================
    ...
    ruta_global = DIR_OUT / "metricas_dimension_fisiologica_nb.csv"
    df_global_modelo.to_csv(ruta_global, index=False, encoding="utf-8-sig")
    print(f"[OK] Métricas globales de la dimensión (Naive Bayes) guardadas en:", ruta_global)
