...
# Carpeta específica para resultados de Naive Bayes en el objetivo somático
DIR_OUT = Path("ObjetivoE_Somatico/resultados_NB")
DIR_OUT.mkdir(parents=True, exist_ok=True)

# ---------------------------------------------------------------------
# DIMENSIÓN SOMÁTICA / FISIOLÓGICA
# ---------------------------------------------------------------------
# Ítems físicos (Sueño, Cansancio, Apetito)
...
# =========================
# HIPERPARÁMETROS NAIVE BAYES (Idénticos al General)
# =========================
# Usamos var_smoothing=0.05 como definiste en tu modelo general
# para evitar overfitting y mantener la consistencia.
NB_PARAMS = dict(
    var_smoothing=0.05 
) 
...
def main():
    ...
    print(f"[INFO] Analizando Dimensión Somática con Naive Bayes (Items 3, 4, 5).")
    ...
    ax_cm.set_title("Matriz de Confusión: Dimensión Somática (Naive Bayes)", fontsize=12, weight='bold')
    ...
    plt.tight_layout()
    ruta_cm = DIR_OUT / "matriz_confusion_somatico_nb.png"
    ...
    df_resumen = pd.DataFrame([{
        "Modelo": "Naive Bayes (Dimensión Somática)",
