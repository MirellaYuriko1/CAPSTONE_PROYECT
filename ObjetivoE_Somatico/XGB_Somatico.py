...
# Carpeta específica para resultados de XGBoost en el objetivo somático
...
def main():
    ...
    print(f"[INFO] Analizando Dimensión Somática con XGBoost ({len(ITEMS)} ítems).")
    ...
    ax_cm.set_title("Matriz de Confusión: Dimensión Somática (XGBoost)", fontsize=12, weight='bold')
    ...
    plt.tight_layout()
    ruta_cm = DIR_OUT / "matriz_confusion_somatico_xgb.png"
    ...
    df_resumen = pd.DataFrame([{
        "Modelo": "XGBoost (Dimensión Somática)",
