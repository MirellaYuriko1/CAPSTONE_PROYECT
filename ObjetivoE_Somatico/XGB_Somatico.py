...
# Carpeta para resultados de XGBoost en el objetivo somático
DIR_OUT = Path("ObjetivoE_Somatico/resultados_XGB")
...
def main():
    ...
    fig.suptitle(
        ...
        f"con respecto a los síntomas de {sintomas_titulo} (XGBoost).",
        fontsize=12,
        y=0.98,
    )
    ...
    ax_cm.set_title("Matriz de confusión — OE2 (XGBoost)", fontsize=12)
    ...
    # ======================================================
    #   CSV RESUMEN GLOBAL PARA LA DIMENSIÓN FISIOLÓGICA
    ...
    ruta_global = DIR_OUT / "metricas_dimension_fisiologica_xgb.csv"
    df_global_modelo.to_csv(ruta_global, index=False, encoding="utf-8-sig")
    print(f"[OK] Métricas globales de la dimensión (XGBoost) guardadas en:", ruta_global)
