...
def main():
    ...
    # ======================================================
    #   CSV RESUMEN POR DIMENSIÓN FISIOLÓGICA (PARA TABLA)
    # ======================================================
    ...
    ruta_global = DIR_OUT / "metricas_dimension_fisiologica_gbm.csv"
    df_global_modelo.to_csv(ruta_global, index=False, encoding="utf-8-sig")
    print(f"[OK] Métricas globales por dimensión (GBM) guardadas en:", ruta_global)
