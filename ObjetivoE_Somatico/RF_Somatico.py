...
# Carpeta específica para resultados de Random Forest en el objetivo somático
DIR_OUT = Path("ObjetivoE_Somatico/resultados_RF")
...
def main():
    ...
    print(f"[INFO] Analizando Dimensión Somática con Random Forest ({len(ITEMS)} ítems).")
    ...
    ax_cm.set_title("Matriz de Confusión: Dimensión Somática (RF)", fontsize=12, weight='bold')
    ...
    plt.tight_layout()
    ruta_cm = DIR_OUT / "matriz_confusion_somatico_rf.png"
    ...
    df_resumen = pd.DataFrame([{
        "Modelo": "Random Forest (Dimensión Somática)",
