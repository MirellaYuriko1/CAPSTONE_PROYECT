...
# Carpeta para resultados de CatBoost en el objetivo somático
...
def main():
    ...
    for item in ITEMS:
        ...
        # IMPORTANTE: aplanar a 1D para evitar errores de pandas
    ...
    # ======================================================
    #   NUEVO: CSV RESUMEN GLOBAL PARA LA DIMENSIÓN
    #   (LISTO PARA LA TABLA DE LA TESIS)
    # ======================================================
    ...
    ruta_global = DIR_OUT / "metricas_dimension_fisiologica_cb.csv"
    df_global_modelo.to_csv(ruta_global, index=False, encoding="utf-8-sig")
    print(f"[OK] Métricas globales de la dimensión (para tabla) guardadas en: {ruta_global}")
