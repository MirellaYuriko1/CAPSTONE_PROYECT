...
# Carpeta específica para resultados de Random Forest en el objetivo cognitivo
...
# =========================
# HIPERPARÁMETROS RANDOM FOREST (Idénticos al General)
# =========================
RF_PARAMS = dict(
    n_estimators=400,
    max_depth=8,           
...
def main():
    ...
    print(f"[INFO] Analizando Dimensión Cognitivo-Afectiva con Random Forest ({len(ITEMS)} ítems).")
    ...
    ax_cm.set_title("Matriz de Confusión: Dimensión Cognitivo-Afectiva (RF)", fontsize=12, weight='bold')
    ...
    plt.tight_layout()
    ruta_cm = DIR_OUT / "matriz_confusion_cognitivo_rf.png"
    ...
    df_resumen = pd.DataFrame([{
        "Modelo": "Random Forest (Dimensión Cognitivo-Afectiva)",
