# RF_O2/RF_O2_cognitivo_afectivo.py
...
# Carpeta para resultados de Random Forest en la dimensión cognitivo-afectiva
DIR_OUT = Path("ObjetivoE_CognitivoAfectivo/resultados_RF")
...
# Hiperparámetros del Random Forest (los mismos de tu modelo oficial general)
RF_PARAMS = dict(
    n_estimators=400,
    max_depth=10,
    min_samples_leaf=5,
...
# =========================
# PROCESO PRINCIPAL DIMENSIÓN COGNITIVO-AFECTIVA RF
# =========================
def main():
    ...
    # ======================================================
    #  CSV RESUMEN GLOBAL DEL MODELO (DIMENSIÓN COGNITIVO-AFECTIVA)
    # ======================================================
    ...
    ruta_global = DIR_OUT / "metricas_dimension_cognitivo_afectiva_rf.csv"
    df_global_modelo.to_csv(ruta_global, index=False, encoding="utf-8-sig")
    print(
        f"[OK] Métricas globales del modelo (RF, dimensión cognitivo-afectiva) "
