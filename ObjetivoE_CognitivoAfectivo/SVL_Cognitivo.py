...
# Carpeta específica para resultados de SVL en el objetivo cognitivo
...
# =========================
# HIPERPARÁMETROS SVM LINEAL (Idénticos al General)
# =========================
SVM_PARAMS = dict(
    kernel="linear",
    C=0.003,
...
def main():
    ...
    print(f"[INFO] Analizando Dimensión Cognitivo-Afectiva con SVM Lineal ({len(ITEMS)} ítems).")
    ...
    ax_cm.set_title("Matriz de Confusión: Dimensión Cognitivo-Afectiva (SVL)", fontsize=12, weight='bold')
    ...
    plt.tight_layout()
    ruta_cm = DIR_OUT / "matriz_confusion_cognitivo_svl.png"
    ...
    df_resumen = pd.DataFrame([{
        "Modelo": "SVM Lineal (Dimensión Cognitivo-Afectiva)",
