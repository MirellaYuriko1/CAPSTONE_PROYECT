# LR_O2/LR_O2_cognitivo_afectivo.py
...
# Carpeta para resultados de Regresión Logística
# en la dimensión cognitivo-afectiva
DIR_OUT = Path("ObjetivoE_CognitivoAfectivo/resultados_LR")
...
# =========================
# PROCESO PRINCIPAL DIMENSIÓN COGNITIVO-AFECTIVA - LR
# =========================
def main():
    ...
    ruta_global = DIR_OUT / "metricas_dimension_cognitivo_afectiva_lr.csv"
    df_global_modelo.to_csv(ruta_global, index=False, encoding="utf-8-sig")
    print(
        f"[OK] Métricas globales de la dimensión (Logistic Regression, cognitivo-afectiva) "
