...
# Carpeta específica para resultados de Naive Bayes en el objetivo cognitivo
...
def main():
    ...
    print(f"[INFO] Analizando Dimensión Cognitivo-Afectiva con Naive Bayes ({len(ITEMS)} ítems).")
    ...
    ax_cm.set_title("Matriz de Confusión: Dimensión Cognitivo-Afectiva (NB)", fontsize=12, weight='bold')
    ...
    plt.tight_layout()
    ruta_cm = DIR_OUT / "matriz_confusion_cognitivo_nb.png"
    ...
    df_resumen = pd.DataFrame([{
        "Modelo": "Naive Bayes (Dimensión Cognitivo-Afectiva)",
