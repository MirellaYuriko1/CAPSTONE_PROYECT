# NB_O2/NB_O2_cognitivo_afectivo.py  (puedes renombrarlo como prefieras)
...
# Carpeta para resultados de Naive Bayes en la dimensión cognitivo-afectiva
DIR_OUT = Path("ObjetivoE_CognitivoAfectivo/resultados_NB")
...
# =========================
# PROCESO PRINCIPAL DIMENSIÓN COGNITIVO-AFECTIVA NB
# =========================
def main():
    ...
    # ======================================================
    #   MÉTRICAS GLOBALES DE LA DIMENSIÓN COGNITIVO-AFECTIVA
    # ======================================================
    ...
    ruta_global = DIR_OUT / "metricas_dimension_cognitivo_afectiva_nb.csv"
    df_global_modelo.to_csv(ruta_global, index=False, encoding="utf-8-sig")
    print(
        f"[OK] Métricas globales de la dimensión cognitivo-afectiva (Naive Bayes) "
        f"guardadas en:", ruta_global
    )
