# SVM_O2/SVM_O2_cognitivo_afectivo.py
...
# Carpeta para resultados de SVM en la dimensión cognitivo-afectiva
DIR_OUT = Path("ObjetivoE_CognitivoAfectivo/resultados_SVM")
...
def make_svm():
    """Pipeline: estandarización + SVM RBF."""
    return Pipeline([
...
def main():
    ...
    ruta_global = DIR_OUT / "metricas_dimension_cognitivo_afectiva_svmrbf.csv"
    df_global_modelo.to_csv(ruta_global, index=False, encoding="utf-8-sig")
    print(
        "[OK] Métricas globales de la dimensión (SVM RBF, cognitivo-afectiva) "
