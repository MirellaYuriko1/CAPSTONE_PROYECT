# GBM_O2/GBM_O2_cognitivo_afectivo.py  (puedes ponerle el nombre que quieras)
...
# Carpeta para resultados de GBM en la dimensión cognitivo-afectiva
...
# Hiperparámetros Gradient Boosting (mismos que tu modelo general)
GBM_PARAMS = dict(
    max_depth=2,
    min_samples_leaf=30,
...
# =========================
# PROCESO PRINCIPAL DIMENSIÓN COGNITIVO-AFECTIVA - GBM
# =========================
def main():
    ...
    # ======================================================
    #   CSV RESUMEN POR DIMENSIÓN COGNITIVO-AFECTIVA (PARA TABLA)
    # ======================================================
    ...
    ruta_global = DIR_OUT / "metricas_dimension_cognitivo_afectiva_gbm.csv"
    df_global_modelo.to_csv(ruta_global, index=False, encoding="utf-8-sig")
    print(
        f"[OK] Métricas globales por dimensión cognitivo-afectiva (GBM) guardadas en:",
        ruta_global,
    )
