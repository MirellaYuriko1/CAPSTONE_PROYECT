# LGBM_O2/LGBM_O2_cognitivo_afectivo.py
...
# Carpeta para resultados de LightGBM en la dimensión cognitivo-afectiva
...
# =========================
# PROCESO PRINCIPAL DIMENSIÓN COGNITIVO-AFECTIVA LGBM
# =========================
def main():
    ...
    # ======================================================
    #   CSV RESUMEN POR DIMENSIÓN COGNITIVO-AFECTIVA (LightGBM)
    # ======================================================
    ...
    ruta_global = DIR_OUT / "metricas_dimension_cognitivo_afectiva_lgbm.csv"
    df_global_modelo.to_csv(ruta_global, index=False, encoding="utf-8-sig")
    print(
        f"[OK] Métricas globales por dimensión cognitivo-afectiva (LGBM) guardadas en:",
        ruta_global,
    )
